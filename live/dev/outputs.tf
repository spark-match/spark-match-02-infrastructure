...
output "bedrock_deploy_role_arn" {
  description = "ARN del role asumido por GitHub Actions de spark-match-07-deep-agent. Wire a AWS_BEDROCK_DEPLOY_ROLE_ARN_DEV."
...
output "agent_ecr_repository_name" {
  description = "Nombre del repositorio ECR del agente. Wire a spark-match-07-deep-agent como repo-level var ECR_REPOSITORY_DEV."
