...
# Access logging
#
# Aqui pesa mas que en los otros buckets del repo: sobre datos personales de
# menores, "quien leyo que informe y cuando" es justo lo que hay que poder
# reconstruir si alguien pregunta. Ref: terraform:S6258 (CWE-778).
###############################################################################
