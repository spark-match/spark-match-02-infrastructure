...
#
# Scope enum matches .commitlintrc.json scope-enum (20 infra scopes):
#   oidc networking security endpoints kms notifications iam observability
#   rds lambda budget live modules terraform ci deps docs governance scripts repo
#
...
SCOPE_RE='(oidc|networking|security|endpoints|kms|notifications|iam|observability|rds|lambda|budget|live|modules|terraform|ci|deps|docs|governance|scripts|repo)'
